...
class GantryViewTemplate extends JView
{
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(
            $isNew ? JText::_('Templates Manager: Add Style')
                    : JText::_('Templates Manager: Edit Style'), 'thememanager'
        );
        ...
        {
            if (!$this->override)
                JToolBarHelper::custom('template.reset', 'purge.png', 'purge_f2.png', 'Reset to Defaults', false);
            else
