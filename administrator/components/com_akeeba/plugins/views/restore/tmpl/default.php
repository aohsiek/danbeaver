...
<form name="adminForm" action="index.php" method="post">
	...
	<fieldset>
		<p class="small"><?php echo JText::_('RESTORE_LABEL_REMOTETIP'); ?></p>
		<table class="adminTable">
		<tr>
			<td><?php echo JText::_('RESTORE_LABEL_EXTRACTIONMETHOD'); ?></td>
	...
	<fieldset>
		...
		<table class="adminTable">
			<tr>
				<td><?php echo JText::_('CONFIG_JPS_KEY_TITLE') ?></td>
				<td><input id="jps_key" name="jps_key" value="" type="password" /></td>
			</tr>
		</table>		
	</fieldset>
		...
		<table class="adminTable">
			...
			<tr>
				...
				<td>
					...
					<button id="ftp-browse" onclick="return false;"><?php echo JText::_('CONFIG_UI_BROWSE') ?></button>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
