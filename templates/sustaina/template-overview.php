<img src="<?php echo $gantry->templateUrl . '/template_thumbnail.png';?>" width="300" height="213" class="template-preview" alt=""/>
<h1><?php echo $gantry->get('template_full_name');?> <span>v<?php echo $gantry->_template->getVersion();?></span></h1>
<p>A theme designed for the Sustainability Academy in Monterey, California.</p>
